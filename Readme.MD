...
- once the compliance reporting service and db are setup then plafform team sets up cloud scheduler to schedule the
compliance reports
- Now cloud run invokes the cloud run api service to run the report
